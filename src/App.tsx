...
function ColorsPage({ onToggleDocs, docsOpenId }: ContentProps) {
  ...
  const colorSwatches: Record<string, { label: string; value: string }[]> = {
    "color-primary": [
      { label: "50", value: "#FFF4FF" },
      { label: "100", value: "#E4D1FF" },
      { label: "200", value: "#CBB8FF" },
      { label: "300", value: "#927FEF" },
      { label: "400", value: "#8068F3" },
      { label: "500", value: "#6245F2" },
      { label: "600", value: "#5442EE" },
      { label: "700", value: "#4936EC" },
      { label: "800", value: "#3123AF" },
      { label: "900", value: "#1F0D87" },
    ],
    "color-secondary": [
      { label: "50", value: "#FDFFFA" },
      { label: "100", value: "#F7FFE5" },
      { label: "200", value: "#EFFFCC" },
      { label: "300", value: "#DEFF99" },
      { label: "400", value: "#CEFF66" },
      { label: "500", value: "#B8FF22" },
      { label: "600", value: "#AEFF00" },
      { label: "700", value: "#9EE800" },
      { label: "800", value: "#6FA202" },
      { label: "900", value: "#3D5900" },
    ],
    "color-neutral": [
      { label: "BG Primary", value: "#161819" },
      { label: "BG Secondary", value: "#252627" },
      { label: "BG Tertiary", value: "#111112" },
      { label: "Border", value: "#323232" },
      { label: "Text", value: "#ffffff" },
      { label: "Text 2nd", value: "#B9BABA" },
      { label: "Text 3rd", value: "#5C5D5E" },
    ],
    "color-extended": [
      { label: "N-50", value: "#F1F1F1" },
      { label: "N-300", value: "#B9BABA" },
      { label: "N-500", value: "#5C5D5E" },
      { label: "N-700", value: "#252627" },
      { label: "N-900", value: "#161819" },
      { label: "CG-50", value: "#F3F5F7" },
      { label: "CG-300", value: "#AEB3B9" },
      { label: "CG-500", value: "#575F6A" },
      { label: "CG-700", value: "#323C48" },
      { label: "CG-900", value: "#141B24" },
    ],
    "color-semantic": [
      { label: "Success", value: "#34D38B" },
      { label: "Success Lt", value: "#10B96D" },
      { label: "Warning", value: "#FFA45F" },
      { label: "Warning Lt", value: "#F5700B" },
      { label: "Error", value: "#FF8378" },
      { label: "Error Lt", value: "#EA6559" },
      { label: "Info", value: "#27E0E0" },
      { label: "Info Lt", value: "#19B0AF" },
    ],
  };
