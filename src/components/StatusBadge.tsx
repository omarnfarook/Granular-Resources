...
const cfg: Record<AssetStatus, { label: string; dot: string; bg: string; text: string }> = {
...
export default function StatusBadge({ status, compact }: StatusBadgeProps) {
  ...
  return (
    <span
      className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[0.6875rem] font-medium leading-none whitespace-nowrap shrink-0"
