...
const patternAssets: AssetItem[] = [
  ...
  },
  {
    ...
    status: "draft",
    placeholder: true,
    copyValue: "<FormLayout />",
    description: "Structured form with labels, inputs, and validation.",
    usage: "Settings pages, data entry, user registration.",
    codeExamples: [{ label: "Basic", code: "<FormLayout>\n  <FormField label=\"Name\">\n    <Input />\n  </FormField>\n</FormLayout>" }],
  },
  {
    id: "pattern-search",
    name: "Search",
